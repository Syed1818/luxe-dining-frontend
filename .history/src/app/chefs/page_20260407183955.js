...
export default function ChefsPage() {
  return (
    <>
      {/* 1. Global Cinematic Background Video */}
      <div className="fixed inset-0 z-[-10] overflow-hidden pointer-events-none">
        ...
        >
          <source src="/chefbg.mp4" type="video/mp4" />
      ...
      <main className="relative z-10 min-h-screen bg-transparent text-zinc-100 overflow-hidden">
        ...
        <section className="relative h-screen flex flex-col items-center justify-center text-center px-4">
          <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <p className="text-zinc-400 text-lg md:text-xl font-light max-w-2xl mx-auto drop-shadow-md">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div>
                ...
                <h3 className="text-xs tracking-[0.3em] text-zinc-400 uppercase mt-4">Executive Chef & Founder</h3>
                <div className="w-16 h-[1px] bg-amber-500 mt-6" />
              </div>
              
              <div className="text-zinc-300 font-light leading-relaxed space-y-6 pt-4">
        ...
        <section className="py-24 bg-[#050505]/60 border-y border-white/5 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-6">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="text-center mb-20">
              <h2 className="text-3xl md:text-5xl font-serif text-white">The Brigade</h2>
              <p className="text-zinc-500 mt-4 tracking-widest uppercase text-sm">Masters of their respective crafts</p>
            </motion.div>
            ...
            >
              {/* Chef 1 */}
              <motion.div variants={fadeInUp} className="group p-6 rounded-[2rem] bg-white/[0.02] border border-white/5 hover:border-amber-500/30 transition-colors duration-500">
                ...
                <h3 className="text-2xl font-serif text-white mb-1">Isabella Rossi</h3>
                <p className="text-amber-500 text-xs tracking-widest uppercase mb-4">Chef de Cuisine</p>
                <p className="text-zinc-400 text-sm font-light leading-relaxed">The conductor of the kitchen during service. Isabella ensures that every dish leaving the pass meets Chef Alexander's exacting standards.</p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="group p-6 rounded-[2rem] bg-white/[0.02] border border-white/5 hover:border-amber-500/30 transition-colors duration-500">
                ...
                <h3 className="text-2xl font-serif text-white mb-1">Elena Dubois</h3>
                <p className="text-amber-500 text-xs tracking-widest uppercase mb-4">Executive Pastry Chef</p>
                <p className="text-zinc-400 text-sm font-light leading-relaxed">An architect of sugar and chocolate. Elena balances the savory menu with desserts that are as structurally stunning as they are delicious.</p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="group p-6 rounded-[2rem] bg-white/[0.02] border border-white/5 hover:border-amber-500/30 transition-colors duration-500">
                ...
                <h3 className="text-2xl font-serif text-white mb-1">Julian Thorne</h3>
                <p className="text-amber-500 text-xs tracking-widest uppercase mb-4">Head Sommelier</p>
                <p className="text-zinc-400 text-sm font-light leading-relaxed">Curator of our 2,000-bottle cellar. Julian travels globally to discover rare vintages that perfectly elevate the tasting menu experience.</p>
              </motion.div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-24 md:py-32 px-6 max-w-7xl mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp} className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-serif text-white">Behind The Line</h2>
            <p className="text-zinc-500 mt-4 tracking-widest uppercase text-sm">The choreography of service</p>
          </motion.div>
          ...
          >
            <motion.div variants={fadeInUp} className="h-[300px] md:h-[500px] rounded-3xl overflow-hidden relative group">
            ...
            <div className="grid grid-rows-2 gap-4 h-[500px]">
              <motion.div variants={fadeInUp} className="rounded-3xl overflow-hidden relative group h-full">
