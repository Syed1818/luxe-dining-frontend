...
export default function ConditionalLayout({ children }) {
  ...
  return (
    <>
      {!isKitchen && (
        <nav className="print:hidden fixed top-6 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none">
      ...
      {!isKitchen && (
        <footer className="print:hidden bg-[#0a0a0a] border-t border-white/5 pt-16 pb-8 px-6 mt-20 relative z-10">
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            <div>
              <h3 className="text-2xl font-serif text-amber-500 mb-4">Luxe Dining</h3>
              <p className="text-zinc-500 text-sm leading-relaxed max-w-xs">An immersive culinary experience blending classic techniques with modern artistry.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">123 Culinary Lane<br />Metropolis, NY 10001<br />reservations@luxedining.com</p>
            </div>
          </div>
          <div className="max-w-6xl mx-auto border-t border-white/5 pt-8 text-center text-xs text-zinc-600">
