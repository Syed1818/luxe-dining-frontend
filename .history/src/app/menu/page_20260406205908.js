...
export default function CatalogMenu() {
  ...
  return (
    <>
      {/* 1. Background Video Wrapper (Fixed Path) */}
      ...
      <main className="relative z-10 min-h-screen text-zinc-100 font-sans selection:bg-amber-500/30 pt-32 pb-20">
        ...
        <div className="max-w-[1600px] mx-auto px-6 flex flex-col lg:flex-row gap-12">
              ...
              <AnimatePresence mode="popLayout">
                {filteredItems.map((item) => (
                  <motion.div 
                    ...
                    className="group flex bg-white/[0.03] backdrop-blur-md border border-white/5 rounded-2xl overflow-hidden hover:bg-white/[0.07] transition-all h-40"
                  >
          ...
          <div className="w-full lg:w-[400px] flex-shrink-0">
            <div className="sticky top-32 p-8 rounded-[2rem] bg-black/40 backdrop-blur-3xl border border-white/10 shadow-2xl">
