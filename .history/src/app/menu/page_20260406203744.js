...
const API_BASE_URL = "https://localhost:7170"; // Make sure this matches your C# port!
const FALLBACK_IMAGE = "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?auto=format&fit=crop&w=800&q=80";

// Custom Spring Animation Configuration for that "Elastic" feel
...
export default function ModernMenu() {
  ...
  // 2. Real-time Kitchen Connection
  useEffect(() => {
  ...
  // 3. Derived State (Categories & Filtering)
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] text-white font-sans overflow-x-hidden selection:bg-amber-500/30 pt-24">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-4 sm:px-8 py-12 flex flex-col xl:flex-row gap-10">
        ...
        <div className="flex-grow pb-32 xl:pb-0">
        ...
        <div className="w-full xl:w-[400px] flex-shrink-0">
          <div className="sticky top-24 p-6 rounded-[2rem] bg-white/[0.03] backdrop-blur-3xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]">
