...
<div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
  <video
    ...
    loop
    playsInline
    className="w-full h-full object-cover opacity-30 grayscale" // Subtlety is key for Luxe
  >
    <source src="/public/video1.mp4" type="video/mp4" />
    {/* Fallback image if video fails to load */}
    <img src="/fallback-hero.jpg" title="Your browser does not support the <video> tag" />
  </video>
